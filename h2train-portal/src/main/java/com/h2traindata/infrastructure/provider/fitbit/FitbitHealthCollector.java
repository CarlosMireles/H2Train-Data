...
public class FitbitHealthCollector implements ProviderEventCollector {

    private final FitbitUserMetricsPayloadFetcher payloadFetcher;
    private final FitbitUserMetricsEventFactory eventFactory;

    public FitbitHealthCollector(FitbitUserMetricsPayloadFetcher payloadFetcher,
    ...
    public EventBatch collect(ProviderConnection connection, SyncCursor cursor) {
        ...
        List<ProviderEvent> events = eventFactory.createHealthEvents(
                providerId(),
