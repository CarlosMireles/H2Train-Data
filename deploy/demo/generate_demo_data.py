...
PROFILES = (
    DemoProfile("demo-u001", 2850, 8500, 7.2, 3, 15, 2400, 2200, 92, 72.0),
    DemoProfile("demo-u002", 2250, 12500, 7.1, 4, 22, 2250, 2500, 88, 68.0),
    DemoProfile("demo-u003", 2200, 7200, 5.3, 2, 8, 2100, 1800, 101, 84.0),
    DemoProfile("demo-u004", 2650, 9800, 6.8, 6, 18, 2600, 2600, 95, 76.0),
    DemoProfile("demo-u005", 2750, 11200, 7.4, 5, 40, 2750, 3000, 90, 70.0),
    DemoProfile("demo-u006", 3100, 14500, 5.7, 6, 45, 2950, 3200, 97, 79.0),
    DemoProfile("demo-u007", 1950, 5500, 8.0, 2, 5, 1900, 1600, 86, 63.0),
    DemoProfile("demo-u008", 2400, 11800, 5.5, 4, 25, 2300, 2400, 104, 81.0),
    DemoProfile("demo-u009", 2900, 9000, 6.3, 3, 12, 2700, 2100, 99, 88.0),
    DemoProfile("demo-u010", 2600, 10500, 7.0, 5, 12, 2500, 2800, 91, 74.0),
    DemoProfile("demo-u011", 2300, 7800, 6.9, 3, 10, 2200, 1900, 108, 93.0, sparse=True),
    DemoProfile("demo-u012", 2450, 9900, 7.6, 4, 28, 2350, 2300, 89, 66.0),
)
